  ...
  const services = [
    {
      ...
      description:
        "Tailored one-on-one sessions, interactive workshops, and immersive retreats focused on navigating life’s most meaningful transitions. Providing individuals, teens, and groups a safe space to pause, realign, and rise like the phoenix.",
      highlights: [
        "Relationship & Transition Coaching (1-on-1)",
        "Teen & Youth Empowerment Workshops",
        "Transformative Group Retreats & Immersive Sessions",
        "Burnout, Confidence & Purpose Mapping",
      ],
    ...
    },
    {
      ...
      highlights: [
        ...
        "POSH Internal Committee (IC) External Member Empanelment",
        "Protection of Children from Sexual Offences (POCSO) Act, 2012",
        "Diversity, Equity, and Inclusion (DEI) & Gender Sensitization",
      ],
      image: heroCoachImg,
    },
    {
      ...
      description:
        "Transforming students into hireable, high-impact professionals through insights drawn straight from 15+ years of HR expertise. We partner with academic institutions to eliminate placement anxiety by teaching students exactly what corporate leaders look for, how to communicate with authority, and how to transition seamlessly into the workplace.",
      highlights: [
        "Communicative & Business English Fluency",
        "Interview Preparation & Self-Assurance Building",
        "Campus-to-Corporate Transition & HR Onboarding Expectations",
        "Professional Grooming, Persona & Workplace EQ",
      ],
